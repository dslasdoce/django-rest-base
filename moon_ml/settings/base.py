"""
Django settings for moon_ml project.
...
SECRET_KEY = 'django-insecure-08008to7culygd$l2p*51hk34dx5&^5cph1^hm4#-h_k0@100j'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': (
        ...
        'moon_ml.renderers.JSONRenderer',
...
WSGI_APPLICATION = 'moon_ml.wsgi.application'
